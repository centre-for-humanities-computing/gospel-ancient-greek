...
# make a list of file numbers from 01 to 66
data = [f"perseus_tlg0007.tlg0{'{:02d}'.format(i)}.perseus-grc" for i in range(1, 67)]
# remove perseus_tlg0007.tlg024.perseus-grc from list
data.remove("perseus_tlg0007.tlg024.perseus-grc")
add_data = ["perseus_tlg0526.tlg002.perseus-grc1", 
            "perseus_tlg0062.tlg008.perseus-grc1",
            "first1k_tlg0018.tlg022.opp-grc1",
            "first1k_tlg0565.tlg004.1st1K-grc1",
            "first1k_tlg2034.tlg002.1st1K-grc1"]
...
data["author_work"] = data["author"] + " - " + data["work"] + ".txt"
...
dst_dir = '/Users/au619572/Documents/git_repos/gospel-ancient-greek/data/raw_single_file/greek_biographies'
